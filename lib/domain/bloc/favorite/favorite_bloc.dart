...
class FavoriteBloc extends Bloc<FavoriteEvent, FavoriteState> {
  ...
  void _onGetFavoriteSpotsEvent(GetFavoriteSpotsEvent event, Emitter<FavoriteState> emit)async {
    try {
  ...
  void _onAddSpotToFavoriteEvent(AddSpotToFavoriteEvent event, Emitter<FavoriteState> emit){
    try {
