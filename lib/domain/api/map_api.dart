...
abstract class MapApi {
  ...
  Future<MapByIdModel> create(String name, String address, String description, double latitude, double longitude, List<XFile>? images);
...
class MapApiImpl implements MapApi {
  ...
  @override
  Future<MapByIdModel> create(String name, String address, String description, double latitude, double longitude, List<XFile>? images) async {
