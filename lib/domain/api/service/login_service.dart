...
class AuthService implements IAuthRepository {
  ...
  Future<Result> login(String email, String password) async {
    ...
    try {
      Response response = await dioClient.dio.post(ApiConstants.LOGIN, data: authObject);
  ...
  Future<Result> registration(String name, String email, String password) async {
    Response response = await dioClient.dio.post(ApiConstants.REGISTRATION, data: {
      "name": name,
      "email": email,
      "password": password,
    });
